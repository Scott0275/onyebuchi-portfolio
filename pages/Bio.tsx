           ...
           <div className="bg-white p-4 rounded-2xl shadow-lg border border-slate-100 text-center">
              <div className="w-32 h-32 mx-auto mb-4 relative">
                ...
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://lh3.googleusercontent.com/gg/AIJ2gl9PgFAs4BmTeelAZTg-OWqqOAS5efcWGlKvqX07VaDh6h46qBreoGVpLEiV32T4i2ODW0qVUAFl6g0b11LkHfKgV1iQuT8iO5BW8JDfbhyqtOfa3aQSlaWlBql2GlwanLu7g9ONyfMEYp4YSX9C7ZxML1ISTMmJUIDsrjXOYvNx6F8RAfQN=s1024-rj-mp2';
                  }}
                />
              </div>
